...
./isorespin.sh -i $ISOFILE -l "*.deb" -p "thermald tlp va-driver-all vainfo libva1 i965-va-driver gstreamer1.0-libav gstreamer1.0-vaapi vlc" -f display/20-intel.conf -f display/30-monitor.conf -f display/90-rotate -f display/90-scale -f display/90-touch -f adduser.local -f display/gpdrotate.sh -f display/gpdrotate.service -f display/wrapper-display.sh -f audio/chtrt5645.conf -f audio/HiFi.conf -f audio/wrapper-audio.sh -f fan/gpdfand -f fan/gpdfand.conf -f fan/gpdfand.py -f fan/gpdfand.service -f fan/wrapper-fan.sh -f network/99-local-bluetooth.rules -f network/brcmfmac4356-pcie.txt -f network/wrapper-network.sh -f power/wrapper-power.sh -c wrapper-audio.sh -c wrapper-display.sh -c wrapper-fan.sh -c wrapper-network.sh -c wrapper-power.sh -g "" -g "i915.fastboot=1"
